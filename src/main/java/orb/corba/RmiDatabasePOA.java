...
public abstract class RmiDatabasePOA extends org.omg.PortableServer.Servant
 implements RmiDatabaseOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("_get_getName", new Integer (0));
    _methods.put ("_get_getTableNames", new Integer (1));
    _methods.put ("getTable", new Integer (2));
    _methods.put ("subtract", new Integer (3));
  }
